...
{
    const char* pszTimestamp = "2021 Oct 10 - Treasury Secretary Janet Yellen said she was confident the U.S. Congress would approve legislation to implement the global corporate minimum tax";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 1 * 60 * 60; // every hour
